...
const shopping_button = document.getElementById('shoppingButton');
const exit_button = document.getElementById('exitButton');
const cart_sidebar = document.getElementById('cartSidebar');
const access_books = document.getElementById('accessBooks');
const search_button = document.getElementById('searchButton');
const search_container = document.getElementById('searchContainer');
const cart_count = document.getElementById('cartCount');
const cart_items = document.getElementById('cartItemsContainer');
const total_price = document.getElementById('totalPrice');
const cart_empty = document.getElementById('cartEmpty');
...
let products = [];
let cart = [];
const bookStoreFetch = () => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield fetch('../database/bookstores.json');
    const data = yield response.json();
    products = data;
    console.log("hhhhhhhhhhhhhhhhhhh", products);
});
const displayProducts = (booksToDisplay) => {
...
const updateSuggestions = (filteredBooks) => {
